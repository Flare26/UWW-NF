public class MaxSubarraySum {
	...
	public static int[] method3(final int A[], int length) {
		int localMax = A[0];
		int globalMax = A[0];
	...
	public static int[] method2(final int A[], int length) {
		return method2(A, 0, length - 1);
	}

	private static int[] method2(final int array[], int left, int right) {
		if (left == right) {
			int answer[] = new int[3];
			answer[0] = array[left];
			answer[1] = left;
	...
	private static int[] method2Helper(final int[] array, int left, int right, int mid) {
	...
	public static int[] method1(final int A[], int length) {
		int globalMax = A[0];
		int globalStartIndex = 0, globalEndIndex = 0;
