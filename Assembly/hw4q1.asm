 ...
 array2  dw  5 dup(?)                  ; each array entry takes up 2 addresses, array2[0] = [ 0000 to 0001]
    ; si and di are at ONE memory address at a time
    ...
    mov cx, 5
        L1: 
             ...
             ;mov dx, [di] ; DOUBLE CHECK the al ---> [di] by showing in dx        
